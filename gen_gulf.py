...
R = [
 dict(slug="yasminepalace", name="Yasmine Palace", ar="قصر الياسمين",
   ...
   cur="ر.ق", phone="+974 4444 4444", email="info@yasminepalace.com", ig="yasminepalace",
   web="https://yasminepalace.com/", addr="Doha, Qatar", hours="Daily · 12:00 — 00:00",
 ...
 dict(slug="najdvillage", name="Najd Village", ar="القرية النجدية",
   ...
   cur="ر.س", phone="+966 11 488 8888", email="info@najdvillage.com", ig="najdvillage",
 ...
 dict(slug="maiz", name="Maiz", ar="ميز",
   ...
   cur="ر.س", phone="+966 11 000 0000", email="hello@maiz.sa", ig="maiz.sa",
   web="https://maiz.sa/", addr="Bujairi Terrace, Diriyah, Riyadh", hours="Tue — Sun · 13:00 — 23:30",
 ...
 dict(slug="mala", name="Mala", ar="مالا",
   ...
   cur="د.ك", phone="+965 0000 0000", email="hello@mala.kw", ig="mala.kw",
   web="#", addr="Kuwait City, Kuwait", hours="Daily · 12:00 — 00:00",
 ...
 dict(slug="gastronomica", name="Gastronomica", ar="غاسترونوميكا",
   ...
   cur="د.ك", phone="+965 0000 0000", email="hello@gastronomica-me.com", ig="gastronomica",
   web="https://gastronomica-me.com/", addr="Multiple locations, Kuwait", hours="Daily · 08:00 — 23:00",
 ...
 dict(slug="bayteltalleh", name="Bayt El Talleh", ar="بيت الطلة",
   ...
   cur="ر.ق", phone="+974 0000 0000", email="info@bayteltalleh.qa", ig="bayteltalleh",
   web="#", addr="Katara Cultural Village, Doha", hours="Daily · 13:00 — 23:00",
