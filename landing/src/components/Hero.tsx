    ...
    <section className="hero">
      <div className="container">
        <div className="hero-content">
          ...
          <h1 className="hero-title">Never Miss Another WhatsApp Enquiry</h1>
          <p className="hero-subtitle">
            We set up an AI WhatsApp receptionist for your local business so customers get instant replies, quotes get qualified, and serious leads reach you faster.
          </p>
